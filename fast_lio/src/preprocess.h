...
enum LID_TYPE
{
  ...
  MID360,
  RSAIRY
};  //{1, 2, 3, 4, 5} RSAIRY: RoboSense Airy (supports XYZI & XYZIRT)
enum TIME_UNIT
{
  SEC = 0,
  MS = 1,
...
// rjy: RoboSense M1/E1R/Airy point type
...
private:
  ...
  void robosenseAiry_handler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg);
